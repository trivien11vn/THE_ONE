                ...
                <div className='flex flex-col gap-[8px]'>
                    <div className='flex gap-[8px]'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_683_25810)">
                            ...
                            <defs>
                            <clipPath id="clip0_683_25810">
                            <rect width="20" height="20" rx="10" fill="white"/>
                            </clipPath>
                            </defs>
                        </svg>
                        <span className='font-normal text-[14px] leading-[24px]'>British</span>
                    </div>
                    <div className='flex gap-[8px]'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_683_25821)">
                        ...
                        <defs>
                        <clipPath id="clip0_683_25821">
                        <rect width="20" height="20" fill="white"/>
                        </clipPath>
                        </defs>
                        </svg>
                        <span className='font-normal text-[14px] leading-[24px]'>French</span>
                    </div>
                    <div className='flex gap-[8px]'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_683_25827)">
                        ...
                        <span className='font-normal text-[14px] leading-[24px]'>Singaporean</span>
                    </div>
                </div>
            </div>
            <div className='flex flex-col gap-[12px]'>
                ...
                <div className='flex flex-col gap-[8px] relative'>
                    <div className='flex gap-[8px]'>
                        ...
                        <span className='font-normal text-[14px] leading-[24px]'>{country[index]?.name}</span>
                    </div>
                    <div className='flex gap-[8px]'>
                        {country[index+1]?.flag}
                        <span className='font-normal text-[14px] leading-[24px]'>{country[index+1]?.name}</span>
                    </div>
                    <div className='flex gap-[8px]'>
                        {country[index+2]?.flag}
                        <span className='font-normal text-[14px] leading-[24px]'>{country[index+2]?.name}</span>
                    </div>
                    <div className='flex gap-[8px]'>
                        {country[index+3]?.flag}
                        <span className='font-normal text-[14px] leading-[24px]'>{country[index+3]?.name}</span>
                    </div>
                    <div className='flex gap-[8px]'>
                        {country[index+4]?.flag}
                        <span className='font-normal text-[14px] leading-[24px]'>{country[index+4]?.name}</span>
                    </div>
