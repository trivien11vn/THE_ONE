  ...
  return (
    <div className='flex flex-col gap-[24px] w-full font-montserrat'>
        ...
        <div className='flex flex-col w-full'>
            <div className='flex w-full'>
                <div className='w-1/3 p-4 border border-[#B9B9B9]'>
                ...
                <div className='w-1/3 p-4 border border-[#B9B9B9] bg-[#FFFCF7]'>
            ...
            <div className='flex w-full'>
                <div className='w-1/3 flex'>
                    <div className='w-[70%] p-4 border border-[#B9B9B9] flex items-center font-montserrat font-bold text-[16px] leading-[21px]'>Airport service</div>
                    <div className='w-[30%] flex flex-col'>
                        <div className='uppercase p-4 border border-[#B9B9B9] font-montserrat font-bold text-[12px] leading-[16px]'>TSN</div>
                        <div className='uppercase p-4 border border-[#B9B9B9] font-montserrat font-bold text-[12px] leading-[16px]'>SYD</div>
                    </div>
                </div>
                <div className='w-1/3 flex flex-col'>
                    <div className='font-montserrat font-medium text-[12px] leading-[16px] uppercase p-4 border border-[#B9B9B9] '>299.40 USD</div>
                    <div className='font-montserrat font-medium text-[12px] leading-[16px] uppercase p-4 border border-[#B9B9B9] '>299.40 USD</div>
                </div>
                <div className='w-1/3 flex flex-col'>
                    <div className='font-montserrat font-medium text-[12px] leading-[16px] uppercase p-4 border border-[#B9B9B9] '>299.40 USD</div>
            ...
            <div className='flex w-full'>
                <div className='w-1/3 p-4 border border-[#B9B9B9]'>
                    <span className='font-montserrat font-bold text-[16px] leading-[21px]'>Total</span>
                </div>
                <div className='w-1/3 p-4 border border-[#B9B9B9]'>
                    <span className='font-montserrat font-medium text-[12px] leading-[16px] uppercase'>299.40 USD</span>
                </div>
            ...
            <div className='flex w-full'>
                ...
                <div className='w-2/3 p-4 border border-[#B9B9B9]'>
        ...
        <div className='flex flex-col w-full'>
            <div className='flex w-full'>
                <div className='w-1/6 p-4 border border-[#B9B9B9]'>
        ...
        <div className='rounded-xl border border-[#545454] flex flex-col p-4 gap-4'>
