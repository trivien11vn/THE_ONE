            ...
            <div className='flex flex-col w-[690px] gap-[40px]'>
                ...
                <div className='w-full p-8 bg-[#FFFCF7] border-2 border-dashed border-[#DA857F] rounded flex items-center justify-center'>
                    ...
                    <input id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                    <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Add Insurance</label>
                                </div>
                                <div class="flex gap-2 mb-4">
                                    ...
                                    <label for="default-radio-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">No Insurance</label>
                                </div>
                            </div>
