...
import { PictureImage } from 'components'
  ...
  return (
    <div className='w-full my-[24px] flex flex-col gap-8 relative'>
      ...
      <div className='w-main mx-auto flex flex-col gap-8'>
        <div className='w-[860px] font-extrabold text-[56px] leading-[64px]'>NEWS</div>
        <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</span>
        <div className='flex justify-between'>
          <div className='px-6 py-2 flex items-center justify-center bg-[#3B7ACC] border-[#3B7ACC] border-2 text-white rounded-2xl '>
            <span className='font-bold text-[16px]'>ALL BLOGS</span>
          </div>
          <div className='px-6 py-2 flex items-center justify-center border-[#3B7ACC] border-2 text-[#2F62A3] rounded-2xl'>
        ...
        <div className='flex justify-between h-[690px]'>
          <div className="relative w-[60%] h-full">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.2)] to-transparent"></div>
