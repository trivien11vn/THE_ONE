...
import airAsia from '../../assets/air_asia.png'
import airCanada from '../../assets/air_canada.svg'
import airBamBoo from '../../assets/airBamBoo.png'
import vietnamAir from '../../assets/vietnamAir.png'
import vietjetAir from '../../assets/vietjetAir.png'
import unitedAir from '../../assets/unitedAir.svg'
import singaporeAir from '../../assets/singoporeAir.png'
import japanAir from '../../assets/japanAir.png'
                                    ...
                                    open1 && 
                                        <div className='w-full flex flex-col gap-[16px]'>
                                            <div className='w-full flex justify-between items-center'>
                                                ...
                                                <path d="M13.759 14.5L10.241 14.5C9.46925 14.5 8.98837 13.6628 9.37726 12.9961L11.1362 9.98076C11.5221 9.31926 12.4779 9.31926 12.8638 9.98076L14.6227 12.9961C15.0116 13.6628 14.5308 14.5 13.759 14.5Z" fill="#3B7ACC" stroke="#6295D6" stroke-linejoin="round"/>
                                                </svg>
                                            </div>
                            ...
                            <div className='flex flex-col gap-[16px] w-full'>
                                ...
                                <div className='w-full flex flex-col items-center gap-[8px]'>
                                    ...
                                    <div className='w-full p-4 flex flex-col gap-[12px]'>
                                        ...
                                        <path d="M153.937 10.3863C153.937 14.7795 150.375 18.3409 145.982 18.3409C141.589 18.3409 138.027 14.7795 138.027 10.3863C138.027 5.99317 141.589 2.43179 145.982 2.43179C150.375 2.43179 153.937 5.99317 153.937 10.3863Z" stroke="#3B7ACC" stroke-width="0.691701"/>
                                        </g>
                                        <defs>
                                        <filter id="filter0_d_6342_16149" x="135.607" y="0.702536" width="20.7508" height="20.7518" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            ...
                            <div className='flex gap-[8px] items-center'>
                                <div className='flex gap-[8px] items-center'>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 17H21M12 11H18M12 5H15M3 14.625L4.50518 16.3183C5.30076 17.2134 6.69924 17.2134 7.49482 16.3183L9 14.625M6 17V5" stroke="#272727" stroke-width="2.2268" stroke-linecap="round"/>
                                    </svg>
