import { InputField, PictureImage } from 'components';
import React, { useState } from 'react'
import { FaExchangeAlt } from "react-icons/fa";
import scenery1 from '../../assets/image_13.jpg'
import scenery2 from '../../assets/image_1.jpg'
import scenery3 from '../../assets/image_12.jpg'
    ...
    return (
        <div className='w-full my-[24px] flex flex-col gap-8 relative'>
            <div className='w-main mx-auto flex flex-col gap-8'>
                ...
                <div className='flex justify-between h-[690px]'>
                    <div className='w-[38%] h-full flex flex-col justify-between'>
                        <div className='w-full h-[48%] relative'>
                            <img src={scenery2} alt="Image" class="w-full h-full" />
                        ...
                        <div className='w-full h-[48%] relative'>
                            <img src={scenery3} alt="Image" class="w-full h-full" />
                            <div class="absolute inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.6)] to-transparent"></div>
                            <div className='absolute left-[60px] bottom-[30px] flex flex-col gap-1'>
                                <span className='font-bold text-[18px] leading-[24px] text-white font-montserrat'>Lorem Ipsum Dolor Sit Amet</span>
                                <span className='font-medium text-[14px] leading-6 text-white font-montserrat'>Lorem Ipsum Dolor Sit Amet</span>
                    ...
                    <div className="relative w-[60%] h-full">
                        <img src={scenery1} alt="Image" class="w-full h-full" />
                        <div class="absolute inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.6)] to-transparent"></div>
                        <div className='absolute left-[60px] bottom-[30px] flex flex-col gap-1'>
                            <span className='font-bold text-[18px] leading-[24px] text-white font-montserrat'>Lorem Ipsum Dolor Sit Amet</span>
                            <span className='font-medium text-[14px] leading-6 text-white font-montserrat'>Lorem Ipsum Dolor Sit Amet</span>
                ...
                <div className='w-full flex justify-between relative'>
                    <div className='w-[64px] h-[64px] rounded-full flex items-center justify-center text-white bg-[#3B7ACC] absolute left-0 transform -translate-x-1/2 top-1/2 -translate-y-1/2'>
                        <SlArrowLeft />
                    </div>
                    <div className='w-[32%]'>
                    ...
                    <div className='w-[64px] h-[64px] rounded-full flex items-center justify-center text-white bg-[#3B7ACC] absolute right-0 transform translate-x-1/2 top-1/2 -translate-y-1/2'>
                        <SlArrowRight />
                    </div>
                </div>
            </div>
