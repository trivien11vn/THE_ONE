...
import { Button_Blue, Button_White } from 'components'
    ...
    <div className='w-full my-[24px] flex flex-col gap-8 relative'>
        ...
        <div className='w-main mx-auto flex flex-col gap-8'>
            <div className='flex items-center'>
                <div className='w-[860px] font-extrabold text-[56px] leading-[64px]'>FAQS</div>
            </div>
            <div className='flex justify-between items-center'>
                <div className='flex flex-col gap-4 w-[40%]'>
                    <span className='font-extrabold text-[40px] leading-[52px] text-[#272727] underline'>LOOKING FOR HELP?</span>
        ...
        <div className='w-main mx-auto flex flex-col gap-[88px] items-center'>
            <span className='font-extrabold text-[48px] leading-[56px]'>EVISA FAQS</span>
            <div className='flex flex-col gap-[40px]'>
                <div className='flex justify-between p-2 border border-[#3B7ACC] rounded-md'>
                    ...
                    <div className='w-[80%] underline font-bold text-[18px] leading-[24px]'>
                    ...
                    <path d="M22.3526 15.8334L17.65 15.8334C16.1065 15.8334 15.1447 17.5078 15.9225 18.8411L18.2737 22.8718C19.0455 24.1949 20.9571 24.1949 21.7289 22.8718L24.0801 18.8411C24.8579 17.5078 23.8961 15.8334 22.3526 15.8334Z" stroke="#3B7ACC" stroke-linejoin="round"/>
                    </svg>
                </div>
                <div className='flex justify-between p-2 border border-[#3B7ACC] rounded-md'>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex flex-col gap-[40px]'>
            ...
            <span className='mx-auto font-extrabold text-[48px] leading-[56px] underline'>MORE QUESTIONS</span>
