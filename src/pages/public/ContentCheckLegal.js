    ...
    <div className='w-full my-[24px] flex flex-col gap-[40px] relative'>
        ...
        <div className='w-main mx-auto flex flex-col gap-[40px]'>
          ...
          <div className='border border-[#7F7F7F] rounded-md flex flex-col'>
            ...
            <div className='px-8 py-4 flex flex-col gap-[24px]'>
                ...
                <div className='flex gap-[32px]'>
                  <div className='w-[30%] p-8 rounded-2xl border border-[#545454] flex flex-col gap-6 items-center'>
                    <div className='flex justify-center items-center w-[248px] h-[74px] border border-[#6295D6] rounded-2xl'>
                      <span className='font-extrabold text-[24px] leading-[32px] text-[#2F62A3] text-center'>LOREM IPSUM DOLOR SIT</span>
                    </div>
                    ...
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M18.666 27.9998L24.5803 33.3227C25.5871 34.2288 27.1514 34.0901 27.983 33.0208L37.3327 20.9998M27.9993 51.3332C40.886 51.3332 51.3327 40.8865 51.3327 27.9998C51.3327 15.1132 40.886 4.6665 27.9993 4.6665C15.1127 4.6665 4.66602 15.1132 4.66602 27.9998C4.66602 40.8865 15.1127 51.3332 27.9993 51.3332Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  ...
                  <div className='w-[30%] p-8 rounded-2xl border border-[#545454] flex flex-col gap-6 items-center'>
                    <div className='flex justify-center items-center w-[248px] h-[74px] border border-[#545454] rounded-2xl'>
                      <span className='font-extrabold text-[24px] leading-[32px] text-[#272727] text-center'>LOREM IPSUM DOLOR SIT</span>
                    </div>
                    <span className='font-light text-[16px] leading-[24px] text-center'>
                      Lorem Ipsum Dolor Sit
                      <br />
          ...
          </div>
          {
            ...
            <div className='flex flex-col gap-[40px]'>
              <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>FREE</span>
              ...
              <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>PROCESSING TIME </span>
                <div className='w-[64px] h-[8px] bg-[#EFA969]'></div>
                <div className='flex flex-col gap-[16px]'>
              ...
              <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>INTRODUCTION ABOUT THE COUNTRY </span>
                <div className='w-[64px] h-[8px] bg-[#EFA969]'></div>
                <div className='flex flex-col gap-[16px]'>
                  <span className='font-montserrat text-[16px] leading-6'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. :</span>
                  <span className='font-montserrat text-[16px] leading-6'>
          ...
          }
          {
            status === 'work' && 
            <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>INTRODUCTION ABOUT THE PROCESS </span>
                <div className='w-[64px] h-[8px] bg-[#EFA969]'></div>
                <div className='flex flex-col gap-[16px]'>
                  <span className='font-montserrat text-[16px] leading-6'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. :</span>
                  <span className='font-montserrat text-[16px] leading-6'>
          ...
          }
          {
            ...
            <div className='flex flex-col gap-[40px]'> 
              <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>INTRODUCTION ABOUT THE STEPS </span>
                <div className='w-[64px] h-[8px] bg-[#EFA969]'></div>
                <div className='flex flex-col gap-[16px]'>
                  <span className='font-montserrat text-[16px] leading-6'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. :</span>
                  <span className='font-montserrat text-[16px] leading-6'>
              ...
              <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>DOCUMENTS TO APPLY </span>
                <div className='w-[64px] h-[8px] bg-[#EFA969]'></div>
                <div className='flex flex-col gap-[16px]'>
                  <span className='font-montserrat text-[16px] leading-6'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. :</span>
                  <span className='font-montserrat text-[16px] leading-6'>
          ...
          }
          {
            status === 'applied' && 
            <div className='flex flex-col gap-[16px] '>
                <span className='font-extrabold text-[40px] leading-[52px] underline' style={{ textDecorationThickness: '2px' }}>INTRODUCTION AFTER APPLIED</span>
                <div className='w-[64px] h-[8px] bg-[#EFA969]'></div>
                <div className='flex flex-col gap-[16px]'>
                  <span className='font-montserrat text-[16px] leading-6'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. :</span>
                  <span className='font-montserrat text-[16px] leading-6'>
