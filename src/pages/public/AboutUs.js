...
import abousUsImage from '../../assets/about_us.svg'
        ...
        <div className='w-main mx-auto flex flex-col gap-8'>
            ...
            <div className='flex flex-col gap-[40px]'>
                <div className='w-full flex items-center justify-between'>
                    ...
                    <img src={abousUsImage} className='w-[420px] h-[532px]'/>
                </div>
                <div className='flex flex-col gap-[40px]'>
                    ...
                    <div className='flex flex-col gap-[40px] items-center'>
                        <div className='flex gap-[40px] justify-between'>
                            <div className='w-[30%] flex flex-col gap-8 p-4 items-center '>
                                ...
                                <svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="80" cy="80" r="79" fill="#F08921" stroke="#EFA969" stroke-width="2"/>
                            ...
                            <div className='w-[30%] flex flex-col gap-8 p-4 items-center '>
                                ...
                                <svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="80" cy="80" r="79" fill="#F08921" stroke="#F08921" stroke-width="2"/>
                        ...
                        <div className='flex gap-[40px] justify-center'>
                            <div className='w-[30%] flex flex-col gap-8 p-4 items-center '>
                                ...
                                <svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="80" cy="80" r="79" fill="#F08921" stroke="#EFA969" stroke-width="2"/>
                                <g clip-path="url(#clip0_2673_44710)">
