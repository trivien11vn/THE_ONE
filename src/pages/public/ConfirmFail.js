...
import confirmFail from '../../assets/confirmfail.svg'
import moneyIcon from '../../assets/money.svg'
import moneyIcon1 from '../../assets/money_1.svg'
        ...
        <div className='w-full my-[24px] flex flex-col gap-2 relative'>
            ...
            <div className='w-main mx-auto flex items-end mt-[100px]'>
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='w-full h-[48px] flex gap-[29px]'>
                        <div className='w-[240px] rounded-2xl flex items-center justify-center bg-[#F08921] text-white'>
                            <span className='font-bold text-[16px] leading-6'>Pay with Paypal</span>
                        </div>
                        <div className='w-[240px] rounded-2xl flex items-center justify-center bg-[#FFFCF7] text-[#F08921] border-2 border-[#F08921]'>
                            <span>Pay with OnePay</span>
                        </div>
                    </div>
                    <span className='font-normal text-[16px] leading-[24px]'>If you prefer to complete the payment via bank transfer, please use the following bank details. </span>
