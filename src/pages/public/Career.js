    ...
    <div className='w-full my-[24px] flex flex-col gap-2 relative'>
        ...
        <div className='w-main mx-auto flex flex-col gap-8'>
            ...
            <div className='flex flex-col gap-[40px]'>
                <div className='w-full flex items-center justify-between'>
                    ...
                    <img src={careerImage} className='w-[450px] h-[550px]'/>
                </div>
                <div className='flex flex-col gap-[40px]'>
                        ...
                        <div className='flex justify-between w-full'>
                            ...
                            <div className='w-[45%] flex flex-col gap-[24px]'>
                                <div className='flex gap-[24px] items-center'>
                                    <svg width="65" height="64" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="32.5" cy="32" r="32" fill="#3B7ACC"/>
                                    <path d="M46.6065 28.5063C45.7353 22.5081 40.9919 17.7647 34.9937 16.8935C33.9006 16.7347 33 17.6454 33 18.75V28.5C33 29.6046 33.8954 30.5 35 30.5H44.75C45.8546 30.5 46.7653 29.5994 46.6065 28.5063Z" stroke="white" stroke-width="2" stroke-linejoin="round"/>
                                    <path d="M28.875 19.8066C23.364 21.0571 19.25 25.9856 19.25 31.875C19.25 38.7095 24.7905 44.25 31.625 44.25C37.5144 44.25 42.4428 40.136 43.6934 34.625" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                    </svg>
                        ...
                        <div className='flex justify-between w-full'>
                            ...
                            <div className='w-[45%] flex flex-col gap-[24px]'>
                                <div className='flex gap-[24px] items-center'>
                                    <svg width="65" height="64" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="32.5" cy="32" r="32" fill="#3B7ACC"/>
                                    <path d="M32.5 28.3334V38.3334" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                    <path d="M37.5 33.3334H27.5" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                    <path d="M25.832 20V18.3334C25.832 15.572 28.0706 13.3334 30.832 13.3334H34.1654C36.9268 13.3334 39.1654 15.572 39.1654 18.3334V20M22.4987 46.6667H42.4987C46.1806 46.6667 49.1654 43.6819 49.1654 40V26.6667C49.1654 22.9848 46.1806 20 42.4987 20H22.4987C18.8168 20 15.832 22.9848 15.832 26.6667V40C15.832 43.6819 18.8168 46.6667 22.4987 46.6667Z" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                    </svg>
        ...
        <div className='w-[1364px] mx-auto flex flex-col gap-4'>
            <div className='w-full flex justify-between'>
                <img src={working} className='w-[33%] h-[295px] object-cover' />
                <img src={working} className='w-[33%] h-[295px] object-cover' />
                <img src={working} className='w-[33%] h-[295px] object-cover' />
            </div>
