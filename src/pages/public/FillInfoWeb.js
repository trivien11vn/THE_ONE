                        ...
                        <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                            <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.6667 7.49984C11.6667 8.42031 10.9206 9.1665 10.0001 9.1665C9.07961 9.1665 8.33341 8.42031 8.33341 7.49984C8.33341 6.57936 9.07961 5.83317 10.0001 5.83317C10.9206 5.83317 11.6667 6.57936 11.6667 7.49984Z" stroke="#545454" stroke-width="1.25"/>
                                    <path d="M15.8334 7.38079C15.8334 9.28443 14.4184 11.6637 12.8688 13.2522C11.8494 14.2971 10.7716 14.9998 10.0001 14.9998C9.22852 14.9998 8.15081 14.2971 7.13138 13.2522C5.58171 11.6637 4.16675 9.28443 4.16675 7.38079C4.16675 4.22488 6.77842 1.6665 10.0001 1.6665C13.2217 1.6665 15.8334 4.22488 15.8334 7.38079Z" stroke="#545454" stroke-width="1.25"/>
                                    <path d="M12.6285 13.4912C15.4742 13.8462 17.5 14.7609 17.5 15.8334C17.5 17.2141 14.1421 18.3334 10 18.3334C5.85786 18.3334 2.5 17.2141 2.5 15.8334C2.5 14.7609 4.52584 13.8462 7.37151 13.4912" stroke="#545454" stroke-width="1.225" stroke-linecap="round"/>
                                </svg>
                                <span>Please Select</span>
                            </div>
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.3513 6.3335L7.64882 6.3335C6.10524 6.3335 5.1435 8.00793 5.92127 9.34124L8.27252 13.372C9.04428 14.695 10.9559 14.695 11.7276 13.372L14.0789 9.34124C14.8567 8.00793 13.8949 6.3335 12.3513 6.3335Z" stroke="#545454" stroke-linejoin="round"/>
                            </svg>
                        </div>
                    </div>
                    <div className='flex flex-col gap-[8px]'>
                        ...
                        <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                            <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.16675 15.2543C4.99066 15.3859 3.62154 16.155 2.61364 16.8323C2.02333 17.229 1.16675 16.8166 1.16675 16.1054V8.04753C1.16675 7.55987 1.37956 7.09594 1.76854 6.80182C2.42028 6.30903 3.51886 5.54545 4.64741 5.0596C4.96193 4.9242 5.27877 4.81037 5.58891 4.72998M6.16675 15.2543C8.932 14.9447 10.0682 18.2222 12.8334 17.9127M6.16675 15.2543V8.98631M12.8334 17.9127C14.3895 17.7385 16.2834 16.4484 17.2316 15.7315C17.6206 15.4373 17.8334 14.9734 17.8334 14.4858V6.42792C17.8334 5.71671 16.9768 5.30429 16.3865 5.70097C16.0569 5.92247 15.6887 6.15378 15.3012 6.3694M12.8334 17.9127V10.2083" stroke="#545454" stroke-width="1.25"/>
                                    <path d="M9.21878 7.03405L7.9561 6.61316C7.59263 6.492 7.57158 5.98582 7.92373 5.8349L11.7923 4.17693C12.138 4.02877 12.4876 4.37833 12.3394 4.72404L10.6815 8.59263C10.5305 8.94478 10.0244 8.92373 9.9032 8.56026L9.4823 7.29758C9.44083 7.17316 9.3432 7.07553 9.21878 7.03405Z" stroke="#545454" stroke-width="1.225"/>
                                    <path d="M15.2498 6.2666C15.2498 9.02803 13.0112 11.2666 10.2498 11.2666C7.48833 11.2666 5.24976 9.02803 5.24976 6.2666C5.24976 3.50518 7.48833 1.2666 10.2498 1.2666C13.0112 1.2666 15.2498 3.50518 15.2498 6.2666Z" stroke="#545454" stroke-width="1.225"/>
                                </svg>
                                <span>Please Select</span>
                            </div>
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='w-[276px] flex flex-col gap-[16px]'>
                            ...
                            <div className='flex flex-col gap-[8px]'>
                                ...
                                <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                    <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                        ...
                                        <path d="M18.3334 9.99984C18.3334 5.39746 14.6025 1.6665 10.0001 1.6665M10.0001 18.3332C5.39771 18.3332 1.66675 14.6022 1.66675 9.99984" stroke="#545454" stroke-linecap="round"/>
                            ...
                            <div className='flex flex-col gap-[8px]'>
                                ...
                                <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                    <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.6667 7.99984C11.6667 8.92031 10.9206 9.6665 10.0001 9.6665C9.07961 9.6665 8.33341 8.92031 8.33341 7.99984C8.33341 7.07936 9.07961 6.33317 10.0001 6.33317C10.9206 6.33317 11.6667 7.07936 11.6667 7.99984Z" stroke="#545454" stroke-width="1.25"/>
                                            <path d="M15.8334 7.88079C15.8334 9.78443 14.4184 12.1637 12.8688 13.7522C11.8494 14.7971 10.7716 15.4998 10.0001 15.4998C9.22852 15.4998 8.15081 14.7971 7.13138 13.7522C5.58171 12.1637 4.16675 9.78443 4.16675 7.88079C4.16675 4.72488 6.77842 2.1665 10.0001 2.1665C13.2217 2.1665 15.8334 4.72488 15.8334 7.88079Z" stroke="#545454" stroke-width="1.25"/>
                                            <path d="M12.6285 13.9912C15.4742 14.3462 17.5 15.2609 17.5 16.3334C17.5 17.7141 14.1421 18.8334 10 18.8334C5.85786 18.8334 2.5 17.7141 2.5 16.3334C2.5 15.2609 4.52584 14.3462 7.37151 13.9912" stroke="#545454" stroke-width="1.25" stroke-linecap="round"/>
                                        </svg>
                                        <span>Enter value</span>
                                    </div>
                                </div>
                            ...
                            <div className='flex flex-col gap-[8px]'>
                                ...
                                <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                    <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.66675 5.83333H4.16675M10.0001 6.66667H15.0001M10.0001 10H15.0001M10.0001 13.3333H12.5001M9.16675 17.5H15.8334C17.2141 17.5 18.3334 16.3807 18.3334 15V5C18.3334 3.61929 17.2141 2.5 15.8334 2.5H9.16675C7.78604 2.5 6.66675 3.61929 6.66675 5V15C6.66675 16.3807 7.78604 17.5 9.16675 17.5ZM2.91675 17.5L3.60692 16.4647C3.97195 15.9172 4.16675 15.2738 4.16675 14.6157V3.75C4.16675 3.05964 3.6071 2.5 2.91675 2.5C2.22639 2.5 1.66675 3.05964 1.66675 3.75V14.6157C1.66675 15.2738 1.86154 15.9172 2.22658 16.4647L2.91675 17.5Z" stroke="#545454" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <span>Enter value</span>
                                    </div>
                                </div>
                            ...
                            <div className='flex flex-col gap-[8px]'>
                                ...
                                <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                    <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2.5 7.49984V14.9998C2.5 16.8408 3.99238 18.3332 5.83333 18.3332H14.1667C16.0076 18.3332 17.5 16.8408 17.5 14.9998V7.49984M2.5 7.49984V6.24984C2.5 4.40889 3.99238 2.9165 5.83333 2.9165H14.1667C16.0076 2.9165 17.5 4.40889 17.5 6.24984V7.49984M2.5 7.49984H17.5M13.3333 1.6665V4.1665M6.66667 1.6665V4.1665" stroke="#545454" stroke-width="1.25" stroke-linecap="round"/>
                                        </svg>
                                        <span>DD/MM/YYYY</span>
                                    </div>
                                </div>
                        ...
                        <div className='w-[276px] flex flex-col gap-[16px]'>
                            <div className='flex flex-col gap-[8px]'>
                                ...
                                <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                    <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2.5 7.49984V14.9998C2.5 16.8408 3.99238 18.3332 5.83333 18.3332H14.1667C16.0076 18.3332 17.5 16.8408 17.5 14.9998V7.49984M2.5 7.49984V6.24984C2.5 4.40889 3.99238 2.9165 5.83333 2.9165H14.1667C16.0076 2.9165 17.5 4.40889 17.5 6.24984V7.49984M2.5 7.49984H17.5M13.3333 1.6665V4.1665M6.66667 1.6665V4.1665" stroke="#545454" stroke-linecap="round"/>
                                        </svg>
                                        <span>DD/MM/YYYY</span>
                                    </div>
                                </div>
